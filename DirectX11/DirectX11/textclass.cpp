...
bool TextClass::InitializeSentence(SentenceType** sentence, int maxLength, ID3D11Device* device)
{
	...
	*sentence = new SentenceType;
	...
	vertices = new TextVertexType[(*sentence)->vertexCount];
	if (!vertices)
	{
		return false;
	}
	...
	vertexBufferDesc.ByteWidth = sizeof(TextVertexType) * (*sentence)->vertexCount;
	...
	ID3D11DeviceContext* deviceContext)
{
	...
	verticesPtr = (TextVertexType*)mappedResource.pData;
