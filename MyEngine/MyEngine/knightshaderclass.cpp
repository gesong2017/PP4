////////////////////////////////////////////////////////////////////////////////
// Filename: knightshaderclass.cpp
////////////////////////////////////////////////////////////////////////////////
#include "knightshaderclass.h"

KnightShaderClass::KnightShaderClass()
{
	m_vertexShader = 0;
	m_pixelShader = 0;
	m_layout = 0;
...
KnightShaderClass::KnightShaderClass(const KnightShaderClass& other)
{
}
...
bool KnightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;


	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"KnightVertexShader.hlsl", L"KnightPixelShader.hlsl");
	if (!result)
	{
		return false;
	}
...
void KnightShaderClass::Shutdown()
{
...
bool KnightShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	HRESULT result;
...
void KnightShaderClass::ShutdownShader()
{
...
void KnightShaderClass::OutputShaderErrorMessage(ID3D10Blob* errorMessage, HWND hwnd, WCHAR* shaderFilename)
{
	char* compileErrors;
