...
CastleClass::CastleClass(const CastleClass& other)
{
}
...
bool CastleClass::Initialize(ID3D11Device* device, WCHAR* modelFilename, WCHAR* textureFilename)
{
	bool result;
...
void CastleClass::Render(ID3D11DeviceContext* deviceContext)
{
...
int CastleClass::GetIndexCount()
{
	return m_indexCount;
}

ID3D11ShaderResourceView* CastleClass::GetTexture()
{
	return m_Texture->GetTexture();
}

bool CastleClass::InitializeBuffers(ID3D11Device* device, WCHAR* modelFilename)
{
...
void CastleClass::ShutdownBuffers()
{
...
void CastleClass::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
bool CastleClass::LoadObjModel(WCHAR* fileName, vector<XMFLOAT3> &out_positions, vector<XMFLOAT2> &out_uvs, vector<XMFLOAT3> &out_normals)
{
...
bool CastleClass::LoadTexture(ID3D11Device* device, WCHAR* filename)
{
	bool result;
...
void CastleClass::ReleaseTexture()
{
