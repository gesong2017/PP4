...
DragonClass::DragonClass(const DragonClass& other)
{
}
...
bool DragonClass::Initialize(ID3D11Device* device, WCHAR* modelFilename, WCHAR* textureFilename)
{
	bool result;
...
void DragonClass::Render(ID3D11DeviceContext* deviceContext)
{
...
int DragonClass::GetIndexCount()
{
	return m_indexCount;
}

ID3D11ShaderResourceView* DragonClass::GetTexture()
{
	return m_Texture->GetTexture();
}

bool DragonClass::InitializeBuffers(ID3D11Device* device, WCHAR* modelFilename)
{
...
void DragonClass::ShutdownBuffers()
{
...
void DragonClass::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
bool DragonClass::LoadObjModel(WCHAR* fileName, vector<XMFLOAT3> &out_positions, vector<XMFLOAT2> &out_uvs, vector<XMFLOAT3> &out_normals)
{
...
bool DragonClass::LoadTexture(ID3D11Device* device, WCHAR* filename)
{
	bool result;
...
void DragonClass::ReleaseTexture()
{
