...
TowerClass::TowerClass(const TowerClass& other)
{
}
...
bool TowerClass::Initialize(ID3D11Device* device, WCHAR* modelFilename, WCHAR* textureFilename)
{
	bool result;
...
void TowerClass::Render(ID3D11DeviceContext* deviceContext)
{
...
int TowerClass::GetIndexCount()
{
	return m_indexCount;
}

ID3D11ShaderResourceView* TowerClass::GetTexture()
{
	return m_Texture->GetTexture();
}

bool TowerClass::InitializeBuffers(ID3D11Device* device, WCHAR* modelFilename)
{
...
void TowerClass::ShutdownBuffers()
{
...
void TowerClass::RenderBuffers(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
bool TowerClass::LoadObjModel(WCHAR* fileName, vector<XMFLOAT3> &out_positions, vector<XMFLOAT2> &out_uvs, vector<XMFLOAT3> &out_normals)
{
...
bool TowerClass::LoadTexture(ID3D11Device* device, WCHAR* filename)
{
	bool result;
...
void TowerClass::ReleaseTexture()
{
